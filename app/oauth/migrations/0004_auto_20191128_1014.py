...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RemoveField(model_name="client", name="client_tls_certificate",),
        migrations.AddField(
            model_name="client",
            name="secret",
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    (
                        ...
                        "rfc822Name SAN entry in the certificate",
                    ),
                ],
                ...
                max_length=128,
                verbose_name="TLS Client Authentication Attribute Name",
            ),
        ),
        migrations.AddField(
            model_name="client",
            ...
            field=models.CharField(
                ...
                max_length=128,
                verbose_name="TLS Client Authentication Attribute Value",
            ),
        ),
        migrations.AddField(
            model_name="client",
